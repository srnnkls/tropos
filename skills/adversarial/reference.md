...
Devil's Advocacy / Red Team Analysis (Heuer & Pherson, *Structured Analytic Techniques*). Assigned role attacks the consensus view using the strongest available counter-arguments.
...
Self-Consistency (Wang et al., 2022). Sample N diverse reasoning paths; the convergent answer is more likely correct. Extensions: Confidence-Improved Self-Consistency (CISC), Adaptive Self-Consistency (RASC).
...
Verbal self-critique is weak without grounding (Miao et al., 2023; Kambhampati, 2024). Effective critique needs sampled paths, tool grounding, or an adversarial agent (CRITIC, Multi-Agent Debate).
