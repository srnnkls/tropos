...
| Valid | Invalid |
|-------|---------|
| `dispatch` | `helper` (vague) |
| `scope` | `utils` (generic) |
| `git worktree` | `claude-tools` (reserved) |
...
Apply the repository-wide [single-source-of-truth contract](../../instructions/AGENTS.md#single-source-of-truth).
